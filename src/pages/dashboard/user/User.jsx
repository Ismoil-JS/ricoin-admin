...
const User = () => {
  ...
  function giveCoins(e) {
    ...
    axios
      .patch('https://api.ricoin.uz/api/users/coins', {
        email: coinEmail,
        coins: +coins
      }, {
        headers, // Include headers in the request
  ...
  return (
    <div>
      ...
      <form onSubmit={giveCoins} className={c.login__form}>
        <input required type="email" placeholder="Email..." onChange={(e) => setCoinEmail(e.target.value)} />
        <input required type="number" placeholder="Coin amount..." onChange={(e) => setCoins(e.target.value)} />
